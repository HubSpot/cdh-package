...
HBASE_BASE_VERSION=0.94.9
HBASE_PKG_VERSION=$(HBASE_BASE_VERSION)
HBASE_RELEASE_VERSION=$(HUBSPOT_VERSION)
HBASE_TARBALL_DST=hbase-$(HBASE_BASE_VERSION)-$(HUBSPOT_VERSION).tar.gz
HBASE_TARBALL_SRC=$(JENKINS_WORKSPACE)/target/$(HBASE_TARBALL_DST)
